...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Past Editions - Egaro Photo Festival</title>
        <meta name="keywords" content="Egaro Photo Festival" />
        <meta name="description"  content="Artists exhibited at Egaro Photo Festival 2016-17, 2017-18, held at Agartala, Tripura...eleven artists/photographers every year...biggest photography event" />
        ...
        <link rel="stylesheet" type="text/css" href="css/past-editions.css" />
    </head>
    <body>
        <nav id="header" class="navbar">
            <a class="navbar-brand" href="index.php"><img src="images/icons/favicon.png" alt="Egaro Photo Festival" /></a>
            ...
            <ul id="nav-menu" class="nav justify-content-center">
                <li class="nav-item"><a href="index.php" class="nav-link">Home<div class="read-more-hover-navbar"></div></a></li>
                <li class="nav-item menu-drop">
                    <a href="index.php#about" class="nav-link">About us <i class="fas fa-angle-down"></i></a>
                    <ul  class="drop1">
                        <li>
                            <a href="index.php#fest-dir" class="nav-link">
                        ...
                        <li>
                            <a href="index.php#about-agartala" class="nav-link">
                        ...
                        <li>
                            <a href="press-media" class="nav-link">
                ...
                <li class="nav-item menu-drop">
                    ...
                    <ul class="drop1">
                        <li>
                            <a href="edition-2017-18" class="nav-link">
                        ...
                        <li>
                            <a href="edition-2016-17" class="nav-link">
        ...
        <div id="menu-expand">
            <div class="menu-expand-container">
                <ul id="small-menu-ul">
                    <li class="nav-item"><a href="index.php" class="nav-link final-tab">Home</a></li>
                    <li class="nav-item">
                        ...
                        <ul  id="about-mobile-drop1" class="mobile-drop1">
                            <li>
                                <a href="index.php#fest-dir" class="nav-link final-tab">
                                    <div class="drop-container-individual">Our Team</div>
                                </a>
                            </li>
                            <li>
                                <a href="index.php#about-agartala" class="nav-link final-tab">
                                    <div class="drop-container-individual">Visitor&apos;s&nbsp;Guide</div>
                                </a>
                            </li>
                            <li>
                                <a href="press-media" class="nav-link final-tab">
                    ...
                    <li class="nav-item">
                        ...
                        <ul id="editions-mobile-drop1" class="mobile-drop1">
                            <li>
                                <a href="edition-2017-18" class="nav-link final-tab">
                                    <div class="drop-container-individual">2017-18</div>
                                </a>
                            </li>
                            <li>
                                <a href="edition-2016-17" class="nav-link final-tab">
                    ...
                    <li class="nav-item">
                        ...
                        <ul id="contact-mobile-drop1" class="mobile-drop1">
                            <li>
                                <a href="registration" class="nav-link final-tab">
                                    <div class="drop-container-individual">Volunteer Registration</div>
                                </a>
                            </li>
                            <li>
                                <a href="index.php#contacts" class="nav-link final-tab">
                ...
                <div class="social">
                    ...
                    <a href="https://twitter.com/Egarophoto" target="_blank"><i class="fab fa-twitter"></i></a>
        ...
        <div class="container edition-content">
            ...
            <div class="row odd">
                ...
                <div class="individual-contents col-8">
                    <p><span class="big">The TV</span></p>
                    ...
                    <div class="blockquote-footer">Adil Hasan<br /></div>
                    <a href="http://www.adilhasan.com" target="_blank">http://www.adilhasan.com</a>

                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/1/1.jpg" data-lightbox="artistgallery1"><img class="img-res" src="images/editions/2017-18/1/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/1/2.jpg" data-lightbox="artistgallery1"><img class="img-res" src="images/editions/2017-18/1/small/2.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row even">
                ...
                <div class="individual-contents col-8">
                    ...
                    <p><span class="big">Ka Dingiei, 2016 – Ongoing</span></p>
                    ...
                    <a href="https://www.aishwarya-arumbakkam.com" target="_blank">https://www.aishwarya-arumbakkam.com</a>

                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/2/1.jpg" data-lightbox="artistgallery2"><img class="img-res" src="images/editions/2017-18/2/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/2/2.jpg" data-lightbox="artistgallery2"><img class="img-res" src="images/editions/2017-18/2/small/2.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/2/3.jpg" data-lightbox="artistgallery2"><img class="img-res" src="images/editions/2017-18/2/small/3.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/2/4.jpg" data-lightbox="artistgallery2"><img class="img-res" src="images/editions/2017-18/2/small/4.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row odd">
                ...
                <div class="individual-contents col-8">
                    <p><span class="big">Train Diaries</span></p>
                    ...
                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/3/1.jpg" data-lightbox="artistgallery3"><img class="img-res" src="images/editions/2017-18/3/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/3/2.jpg" data-lightbox="artistgallery3"><img class="img-res" src="images/editions/2017-18/3/small/2.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/3/3.jpg" data-lightbox="artistgallery3"><img class="img-res" src="images/editions/2017-18/3/small/3.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/3/4.jpg" data-lightbox="artistgallery3"><img class="img-res" src="images/editions/2017-18/3/small/4.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/3/5.jpg" data-lightbox="artistgallery3"><img class="img-res" src="images/editions/2017-18/3/small/5.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row even">
                ...
                <div class="individual-contents col-8">
                    <p><span class="big">Do not go to the garden of flowers!</span></p>
                    <p>The series, is based on a poem by Kabir by the same name.</p>
                    <blockquote>
                    ...
                    <a href="http://arkapatra.com" target="_blank">http://arkapatra.com</a>

                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/4/1.jpg" data-lightbox="artistgallery4"><img class="img-res" src="images/editions/2017-18/4/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/4/2.jpg" data-lightbox="artistgallery4"><img class="img-res" src="images/editions/2017-18/4/small/2.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row odd">
                ...
                <div class="individual-contents col-8">
                    <p><span class="big">Giraffe Behind the Door</span></p>
                    ...
                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/5/1.jpg" data-lightbox="artistgallery5"><img class="img-res" src="images/editions/2017-18/5/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/5/2.jpg" data-lightbox="artistgallery5"><img class="img-res" src="images/editions/2017-18/5/small/2.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row even">
                ...
                <div class="individual-contents col-8">
                    ...
                    <a href="http://www.gayatriganju.com" target="_blank">http://www.gayatriganju.com</a>


                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/6/1.jpg" data-lightbox="artistgallery6"><img class="img-res" src="images/editions/2017-18/6/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/6/2.jpg" data-lightbox="artistgallery6"><img class="img-res" src="images/editions/2017-18/6/small/2.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row odd">
                ...
                <div class="individual-contents col-8">
                    ...
                    <p><span class="big">Alopecia areata</span></p>
                    ...
                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/7/1.jpg" data-lightbox="artistgallery7"><img class="img-res" src="images/editions/2017-18/7/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/7/2.jpg" data-lightbox="artistgallery7"><img class="img-res" src="images/editions/2017-18/7/small/2.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/7/3.jpg" data-lightbox="artistgallery7"><img class="img-res" src="images/editions/2017-18/7/small/3.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/7/4.jpg" data-lightbox="artistgallery7"><img class="img-res" src="images/editions/2017-18/7/small/4.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/7/5.jpg" data-lightbox="artistgallery7"><img class="img-res" src="images/editions/2017-18/7/small/5.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/7/6.jpg" data-lightbox="artistgallery7"><img class="img-res" src="images/editions/2017-18/7/small/6.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/7/7.jpg" data-lightbox="artistgallery7"><img class="img-res" src="images/editions/2017-18/7/small/7.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/7/8.jpg" data-lightbox="artistgallery7"><img class="img-res" src="images/editions/2017-18/7/small/8.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row even">
                ...
                <div class="individual-contents col-8">
                    ...
                    <p><span class="big">So Much Water So Close To Home</span></p>
                    ...
                    <a href="http://www.parthgupta.net" target="_blank">http://www.parthgupta.net</a>

                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/8/1.jpg" data-lightbox="artistgallery8"><img class="img-res" src="images/editions/2017-18/8/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/8/1.jpg" data-lightbox="artistgallery8"><img class="img-res" src="images/editions/2017-18/8/small/1.jpg" alt="images"></a>
                        </div>
            ...
            <div class="row odd">
                ...
                <div class="individual-contents col-8">
                    <p><span class="big">Elysium</span></p>
                    ...
                    <a href="http://sandeepdhopate.com" target="_blank">http://sandeepdhopate.com</a>

                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/9/1.jpg" data-lightbox="artistgallery9"><img class="img-res" src="images/editions/2017-18/9/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/9/2.jpg" data-lightbox="artistgallery9"><img class="img-res" src="images/editions/2017-18/9/small/2.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/9/3.jpg" data-lightbox="artistgallery9"><img class="img-res" src="images/editions/2017-18/9/small/3.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row even">
                ...
                <div class="individual-contents col-8">
                    ...
                    <p>
                        <a href="http://www.sathishphoto.com" target="_blank">http://www.sathishphoto.com</a>
                    </p>

                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/10/1.jpg" data-lightbox="artistgallery10"><img class="img-res" src="images/editions/2017-18/10/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/10/2.jpg" data-lightbox="artistgallery10"><img class="img-res" src="images/editions/2017-18/10/small/2.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/10/3.jpg" data-lightbox="artistgallery10"><img class="img-res" src="images/editions/2017-18/10/small/3.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/10/4.jpg" data-lightbox="artistgallery10"><img class="img-res" src="images/editions/2017-18/10/small/4.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row odd">
                ...
                <p><span class="big">Beyond Street</span></p>
                    ...
                    <div class="row thumb-container">
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/11/1.jpg" data-lightbox="artistgallery11"><img class="img-res" src="images/editions/2017-18/11/small/1.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/11/2.jpg" data-lightbox="artistgallery11"><img class="img-res" src="images/editions/2017-18/11/small/2.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/11/3.jpg" data-lightbox="artistgallery11"><img class="img-res" src="images/editions/2017-18/11/small/3.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/11/4.jpg" data-lightbox="artistgallery11"><img class="img-res" src="images/editions/2017-18/11/small/4.jpg" alt="images"></a>
                        </div>
                        <div class="thumb">
                            <a class="modal-anchor" href="images/editions/2017-18/11/5.jpg" data-lightbox="artistgallery11"><img class="img-res" src="images/editions/2017-18/11/small/5.jpg" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <a class="no-text-decoration" href="index.php#about">
                        <div class="read-more">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    ...
                    <div class="row"><div class="col-1"><i class="fab fa-twitter"></i></div><div class="col-11"><a href="https://twitter.com/Egarophoto" target="_blank">Egarophoto</a></div></div>
                ...
                <div class="sitemap col-lg-3 col-12">
                    <div class="footer-caption">Important&nbsp;Links</div>
                    <div class="row">
                        <i class="fas fa-angle-right"><span class="content">&nbsp;&nbsp;<a href="index.php">Home</a></span></i>
                    </div>
                    <div class="row">
                        <i class="fas fa-angle-right"><span class="content">&nbsp;&nbsp;<a href="index.php#about">About&nbsp;us</a></span></i>
                    </div>
                    <div class="row">
                        <i class="fas fa-angle-right"><span class="content">&nbsp;&nbsp;<a href="photos">Photos</a></span></i>
                    </div>
                    <div class="row">
                        <i class="fas fa-angle-right"><span class="content">&nbsp;&nbsp;<a href="videos">Videos</a></span></i>
                    </div>
                    <div class="row">
                        <i class="fas fa-angle-right"><span class="content">&nbsp;&nbsp;<a href="index.php#contacts">Contact</a></span></i>
                    </div>
                </div>
            </div>
        </footer>
        ...
        <script src="js/past-editions.js"></script>
    </body>
</html>
